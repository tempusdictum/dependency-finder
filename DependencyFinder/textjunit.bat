...
set LOCAL_CLASSPATH=%LOCAL_CLASSPATH%;%CATALINA_HOME%\lib\ecj-3.6.2.jar
...
set LOCAL_CLASSPATH=%LOCAL_CLASSPATH%;%CATALINA_HOME%\lib\tomcat-api.jar
...
set LOCAL_CLASSPATH=%LOCAL_CLASSPATH%;%CATALINA_HOME%\lib\tomcat-i18n-ja.jar
set LOCAL_CLASSPATH=%LOCAL_CLASSPATH%;%CATALINA_HOME%\lib\tomcat-util.jar
